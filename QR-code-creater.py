...
def generateCode():
    ...
    messagebox.showinfo("Thank You","QR Code is saved successfully!")
...
Frame1 = Frame(wn,bg="red1")
Frame1.place(relx=0.1,rely=0.15,relwidth=0.7,relheight=0.3)
    
lable1 = Label(Frame1,text="Enter the text/URL: ",bg="red1",fg='azure',font=('Courier',13,'bold'))
...
Frame2 = Frame(wn,bg="red1")
Frame2.place(relx=0.1,rely=0.35,relwidth=0.7,relheight=0.3)

lable2 = Label(Frame2,text="Enter the location to save the QR Code: ",bg="red1",fg='azure',font=('Courier',13,'bold'))
...
Frame3 = Frame(wn,bg="red1")
Frame3.place(relx=0.1,rely=0.55,relwidth=0.7,relheight=0.3)

lable3 = Label(Frame3,text="Enter name for the QR Code: ",bg="red1",fg='azure',font=('Courier',13,'bold'))
...
Frame4 = Frame(wn,bg="red1")
Frame4.place(relx=0.1,rely=0.75,relwidth=0.7,relheight=0.2)

lable4 = Label(Frame4,text="Enter the size from 1 to 40 with 1 being 21x21: ",bg="red1",fg='azure',font=('Courier',13,'bold'))
lable4.place(relx=0.05,rely=0.2, relheight=0.15)
